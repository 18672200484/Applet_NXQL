            ...
            try
            {
                switch (this.CurrentFlowFlag)
                {
                    ...
                    case eFlowFlag.等待校验:
                        ...
                        if (czyHandlerDAO.UpdateRCSampleBarrelCheckSampleWeight(this.rCSampleBarrel.Id, wber.Weight))
                        {
                            ...
                            if (this.IsScanedRCSampleBarrelId.Count == this.brotherRCSampleBarrels.Count)
                            {
                                ...
                                if (this.RCMake != null)
                                    this.CurrentFlowFlag = eFlowFlag.打印编码;
                                else
                    ...
                    case eFlowFlag.打印编码:
                        ...
                        if (MessageBoxEx.Show("制样码：" + this.RCMake.MakeCode + "，立刻打印？", "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {

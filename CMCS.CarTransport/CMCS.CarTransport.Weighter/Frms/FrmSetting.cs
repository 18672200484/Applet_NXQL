...
namespace CMCS.CarTransport.Weighter.Frms
{
	public partial class FrmSetting : DevComponents.DotNetBar.Metro.MetroForm
	{
		...
		void InitForm()
		{
			...
			InitNumberAscComboBoxs(1, 15, cmbInductorCoil1Port, cmbInductorCoil2Port, cmbInductorCoil3Port, cmbInductorCoil4Port, cmbInfraredSensor1Port, cmbInfraredSensor2Port, cmbInfraredSensor3Port, cmbGate1UpPort, cmbGate1DownPort, cmbGate2UpPort, cmbGate2DownPort, cmbSignalLight1Port, cmbSignalLight2Port);
		...
		void LoadAppConfig()
		{
			...
			SelectedComboBoxItem(cmbInfraredSensor3Port, commonDAO.GetAppletConfigInt32("IO控制器_对射3端口").ToString());
			...
			ip_Rwer2.Value = commonDAO.GetAppletConfigString("读卡器2_IP地址");
		...
		bool SaveAppConfig()
		{
			...
			commonDAO.SetAppletConfig("IO控制器_对射3端口", (cmbInfraredSensor3Port.SelectedItem as DataItem).Value);
			...
			commonDAO.SetAppletConfig("读卡器2_IP地址", ip_Rwer2.Value);
			commonDAO.SetAppletConfig("读卡器1_功率", cmbip_Rwer1Port.Text);
			commonDAO.SetAppletConfig("读卡器2_功率", cmbip_Rwer2Port.Text);

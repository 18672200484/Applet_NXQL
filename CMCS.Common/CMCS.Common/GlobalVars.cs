...
namespace CMCS.Common
{
	...
	public static class GlobalVars
	{
		...
		/// 设备编码 - 汽车机械采样机 #1
		/// </summary>
		public static string MachineCode_QCJXCYJ_1 = "#1机械采样机";

		/// <summary>
		/// 设备编码 - 汽车机械采样机 #2
		/// </summary>
		public static string MachineCode_QCJXCYJ_2 = "#2机械采样机";
		...
		/// 设备编码-汽车智能化-#1过衡端
		/// </summary>
		public static string MachineCode_QC_Weighter_1 = "#1汽车衡";
		/// <summary>
		/// 设备编码-汽车智能化-#2过衡端
		/// </summary>
		public static string MachineCode_QC_Weighter_2 = "#2汽车衡";
		/// <summary>
		/// 设备编码-汽车智能化-#3过衡端
		/// </summary>
		public static string MachineCode_QC_Weighter_3 = "#3汽车衡";
		/// <summary>
		/// 设备编码-汽车智能化-#4过衡端
		/// </summary>
		public static string MachineCode_QC_Weighter_4 = "#4汽车衡";
		/// <summary>
		/// 设备编码-汽车智能化-#5过衡端
		/// </summary>

...
namespace CMCS.Common.Entities.CarTransport
{
	...
	public class CmcsAutotruck : EntityBase1
	{
		...
		/// 运输单位ID
		/// </summary>
		public virtual string SendSupplierId { get { return _SendSupplierId; } set { _SendSupplierId = value; } }

		private string _InsuranceType;
		/// <summary>
		/// 险种
		/// </summary>
		public virtual string InsuranceType { get { return _InsuranceType; } set { _InsuranceType = value; } }

		private int _CarAge;
		/// <summary>
		/// 车龄
		/// </summary>
		public virtual int CarAge { get { return _CarAge; } set { _CarAge = value; } }

		private int _DriverAge;
		/// <summary>
		/// 司机年龄
		/// </summary>
		public virtual int DriverAge { get { return _DriverAge; } set { _DriverAge = value; } }
		...
		public CmcsEPCCard TheEPCCard
		{
			get { return CommonDAO.GetInstance().SelfDber.Get<CmcsEPCCard>(this.EPCCardId); }
		}
	}
}

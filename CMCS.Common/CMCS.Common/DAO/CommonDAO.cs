...
namespace CMCS.Common.DAO
{
	...
	public class CommonDAO
	{
		...
		public string GetAppletConfigString(string appIdentifier, string configName)
		{
			...
			{
				SelfDber.Insert(new CmcsAppletConfig()
				{
		...
		public string CreateNewSampleCode(DateTime dt)
		{
			...
			do
			{
				res = string.Format("{0}{1}", "C" + DateTime.Parse(dt.ToString()).ToString("yyMMdd"), new Random().Next(0, 100).ToString().PadLeft(3, '0'));
		...
		public string CreateNewMakeCode(DateTime dt)
		{
			...
			do
			{
				res = string.Format("{0}{1}", "Z" + dt.ToString("yyMMdd"), new Random().Next(100, 200).ToString().PadLeft(3, '0'));
		...
		public string CreateNewAssayCode(DateTime dt)
		{
			...
			do
			{
				res = string.Format("{0}{1}", "H" + dt.ToString("yyMMdd"), new Random().Next(200, 300).ToString().PadLeft(3, '0'));

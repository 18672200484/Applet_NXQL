namespace CMCS.DataTester
{
    partial class MDIParent1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnOpenFrmCarLocation = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.车号识别ToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.btnOpenFrmBuildTrainWeightRecord.Size = new System.Drawing.Size(180, 22);
			...
			this.btnOpenFrmBuildTrainCarriagePass.Size = new System.Drawing.Size(180, 22);
            ...
            this.btnOpenFrmCarLocation,
            this.车号识别ToolStripMenuItem});
			...
			// 
			// btnOpenFrmCarLocation
			// 
			this.btnOpenFrmCarLocation.Name = "btnOpenFrmCarLocation";
			this.btnOpenFrmCarLocation.Size = new System.Drawing.Size(240, 22);
			this.btnOpenFrmCarLocation.Text = "在途车辆实时位置模拟工具";
			this.btnOpenFrmCarLocation.Click += new System.EventHandler(this.btnOpenFrmCarLocation_Click);
			// 
			// windowsMenu
			// 
			...
			// 
			// 车号识别ToolStripMenuItem
			// 
			this.车号识别ToolStripMenuItem.Name = "车号识别ToolStripMenuItem";
			this.车号识别ToolStripMenuItem.Size = new System.Drawing.Size(240, 22);
			this.车号识别ToolStripMenuItem.Text = "车号识别";
			this.车号识别ToolStripMenuItem.Click += new System.EventHandler(this.车号识别ToolStripMenuItem_Click);
			// 
			// MDIParent1
			// 
        ...
        private System.Windows.Forms.ToolStripMenuItem btnOpenFrmCarLocation;
		private System.Windows.Forms.ToolStripMenuItem 车号识别ToolStripMenuItem;
	}
}
